...
const serviceElements = element.closest(".tourInventory__details__item").querySelectorAll(".tourInventory__details__item__service");
const sevice = [...serviceElements].map(el => {
  switch (parseInt(el.dataset.value)) {
    ...
    $bc.setSource("db.tourForm", {
        hotelName: Array.from(element.closest(".tourInventory__details__item").querySelectorAll(".showhotel")).map(el => el.textContent.trim()).join("، "),
...
const OnProcessedTourBookingForm = async (args) => {
    try {
        ...
        let dropdown = document.querySelector(".tour__booking__form__modal__container .dropdown-modal-content");
        if(dropdown){
...
const OnProcessedTourBookingFormIns = async (args) => {
    try {
        ...
        let dropdown = document.querySelector(".tour__booking__form__modal__container_Ins .dropdown-modal-content");
        if(dropdown){
            dropdown.querySelector(".dropdown-modal-tour").classList.add("hidden");
        }
