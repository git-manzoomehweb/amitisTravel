    ...
    if (playPauseBtn && audioElement) {
      ...
      function togglePlayPause() {
        if (wavesurfer.isPlaying()) {
          ...
          document.querySelector(".playPause").classList.remove("active-playPause")
        } else {
          // توقف ویدیو در صورت وجود
          const iframe = document.querySelector("#videoContainer iframe");
          if (iframe) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const destinationItems = document.querySelectorAll(".destination-items article");
...
function show_contact_opt(e) {
      e.closest(".each-contact-opt").querySelector(".contact-opt").classList.toggle("hidden");
...
if(document.querySelector('.about-counter-list') && document.querySelector('.about-counter')){
...
if(document.querySelector('.most-visited-section') && document.querySelector('.slider')){
...
if(document.querySelector(".audio-extra-tour") && document.querySelector(".tour-list-name")){
